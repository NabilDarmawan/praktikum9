...
<div class="letak">
	...
	<div class="card">
		...
		<div class="bgheader">REGISTRASI PESERTA DIDIK</div>
		<br>
		<div class="card-body">

			<form method="POST" action="simpandata.php" id="peserta">
				<!-- Jenis Pendaftaran -->
				<div class="form-group row">
					<label class="col-sm-2 col-form-label">Jenis Pendaftaran</label>
					<div class="col-sm-10">
						<select name="jenispendaftaran" class="form-control" required="">
							<option selected disabled value="">-- Klik untuk pilih --</option>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="number" name="skhun" class="textbox"  placeholder="No. Seri SKHUN" required=""> 
						<span style="font-size: 11px; text-decoration-line: initial;">
							<p>
								<i>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="number" name="ijazah" class="textbox"  placeholder="No. Seri IJAZAH" required=""> 
						<span style="font-size: 11px; text-decoration-line: initial;">
							<p>
								<i>
									Diisi 16 digit yang tertera di
				...
				<!-- Form Data Pribadi -->
				<div class="bgheader">DATA PRIBADI</div>
				<br>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" name="tempatlahir" class="textbox"  placeholder="Tempat Lahir" required="">
					</div>
				</div>
				<!-- Tanggal Lahir -->
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="date" name="tgllahir" class="textbox" required="">
					</div>
				</div>
				<!-- Agama -->
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select name="agama" class="textbox" required="">
							<option selected disabled value="">-- Klik untuk pilih --</option>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" name="rt" class="textbox"  placeholder="RT" required="">
					</div>
				</div>
				<!-- RW -->
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<input type="text" name="rw" class="textbox"  placeholder="RW" required="">
					</div>
				</div>
				<!-- Nama Dusun -->
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<select name="tinggal" class="textbox" required="">
							<option selected disabled value="">-- Klik untuk pilih --</option>
				...
				<div class="bgheader">DATA AYAH KANDUNG</div>
				<br>
				<div class="form-group row">
					<label class="col-sm-2 col-form-label">Nama Ayah Kandung</label>
					<div class="col-sm-10">
						<input type="text" name="namaayah" class="form-control"  placeholder="Nama Lengkap" required="">
					</div>
				</div>
				<!-- Form Tahun Lahir Ayah -->
				<div class="form-group row">
					<label class="col-sm-2 col-form-label">Tanggal Lahir</label>
					<div class="col-sm-10">
						<input type="date" name="thnlahirayah" class="textbox" required="">
					</div>
				</div>
				<!-- Form Pendidikan Ayah-->
				<div class="form-group row">
				...
				<div class="bgheader">DATA IBU KANDUNG</div>
				<br>
				<div class="form-group row">
					<label class="col-sm-2 col-form-label">Nama Ibu Kandung</label>
					<div class="col-sm-10">
						<input type="text" name="namaibu" class="form-control"  placeholder="Nama Lengkap" required="">
					</div>
				</div>
				<!-- Form Tahun Lahir Ibu -->
				<div class="form-group row">
					<label class="col-sm-2 col-form-label">Tanggal Lahir</label>
					<div class="col-sm-10">
						<input type="date" name="thnlahiribu" class="textbox" required="">
					</div>
				</div>
				<!-- Form Pendidikan Ibu-->
				<div class="form-group row">
				...
				<div class="form-group row">
					<div class="col-sm-10">
						<button type="submit" name="submit" class="btn btn-primary">Daftarkan</button>
					</div>
				</div>
			</form>
		</div>
